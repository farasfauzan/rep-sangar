        ...
        <ToastContext.Provider value={toast}>
            ...
            >
                {toasts.map((t) => (
                    <div
                        key={t.id}
                        className={`flex items-start gap-3 p-4 rounded-lg border shadow-lg animate-slide-in ${toastBgColors[t.type] || toastBgColors.info}`}
                        role="alert"
                    >
                        <span className="flex-shrink-0 mt-0.5">{toastIcons[t.type]}</span>
