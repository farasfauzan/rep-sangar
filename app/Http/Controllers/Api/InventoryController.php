    ...
    public function store(Request $request)
    {
        ...
        $invoice = DB::transaction(function () use ($validated) {
            if ($validated['invoiceable_type'] === PurchaseOrder::class) {
                ...
                // Hitung total nilai barang yang sudah DITERIMA (Receipt) oleh orang lapangan
                $receivedSubtotal = 0;
                ...
                // Hitung proporsi diskon dan pajak agar akurat secara akuntansi
                ...
                // Kurangi dengan nilai yang SUDAH DITAGIHKAN pada termin/invoice sebelumnya
